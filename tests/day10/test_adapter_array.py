...
from aoc.day10.adapter_array import find_joltage_difference, find_adapters_arrangements
...
class TestFindAdaptersArrangements:
    def test_should_validate_first_example(self):
        # GIVEN
        raw_adapters = """16
10
...
4"""
        ...
        # WHEN
        res = find_adapters_arrangements(
            adapters=list(map(int, raw_adapters.splitlines(keepends=True)))
        )
...
3"""
        ...
        # THEN
        assert_that(res, equal_to(19208))
